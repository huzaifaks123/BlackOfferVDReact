    ...
    return (
        <>
            <div className={`container row gx-5 d-flex justify-content-between w-100 mx-0 p-2 ${styles.container}`}>
                ...
                <div className={`col-md rounded p-2 ${styles.card}`}><SplineChart data={data} /></div>
            </div>
            <div className={`container row gx-5 d-flex justify-content-between w-100 mx-0 p-2 ${styles.container}`}>
                <div className={`col-md mx-1 rounded p-2 ${styles.card}`}><AreaChart data={data} /></div>
                <div className={`col-md mx-1 rounded p-2 ${styles.card}`}><StepAreaChart data={data} /></div>
            </div>
        </>
    )
}
